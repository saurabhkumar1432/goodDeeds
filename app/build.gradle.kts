...
android {
    namespace = "com.browniepoints.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.browniepoints.app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.browniepoints.app.FirebaseTestRunner"
        vectorDrawables {
...
dependencies {
    ...
    // Firebase Testing with Emulator
